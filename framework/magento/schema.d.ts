...
interface CategoryInterface {
  ...
  default_sort_by: Scalars["String"];
  products: CategoryProducts;
  breadcrumbs: Array<Breadcrumb>;
}

export type CategoryTree = {
  available_sort_by: Array<Scalars["String"]>;
  breadcrumbs: Array<Breadcrumb>;
  canonical_url: Scalars["String"];
  children: Array<CategoryTree>;
  children_count: Scalars["String"];
  cms_block: CmsBlock;
  custom_layout_update_file: Scalars["String"];
  default_sort_by: Scalars["String"];
  description: Scalars["String"];
  display_mode: Scalars["String"];
  filter_price_range: Scalars["Float"];
  image: Scalars["String"];
  include_in_menu: Scalars["Int"];
  is_anchor: Scalars["Int"];
  landing_page: Scalars["Int"];
  level: Scalars["Int"];
  ...
  titlecat: Scalars["String"];
  type: UrlRewriteEntityTypeEnum;
  uid: Scalars["String"];
  url_key: Scalars["String"];
  url_path: Scalars["String"];
  url_suffix: Scalars["String"];
};
...
export type MultiSelectAttributes<T> = {
...
export type ProductLinks = {
  ...
  linked_product_sku: Scalars["String"];
  linked_product_type: Scalars["String"];
  position: Scalars["Int"];
  sku: Scalars["String"];
};
...
export type UrlRewrite = {
  parameters: Array<HttpQueryParameter>;
  url: Scalars["String"];
};
...
export type ProductItem = {
  additional_information: Scalars["String"];
  builder: Scalars["String"];
  canonical_url: Scalars["String"];
  categories: Array<CategoryTree>;
  country_of_manufacture: Scalars["String"];
  crosssell_products: Array<ProductItem[]>;
  customattributes: MultiSelectAttributes;
  description: ComplexTextValue;
  exterior_designer: Scalars["String"];
  gift_message_available: Scalars["String"];
  image: ProductImage;
  media_gallery: ProductImage[];
  meta_description: Scalars["String"];
  meta_keyword: Scalars["String"];
  meta_title: Scalars["String"];
  name: Scalars["String"];
  new_from_date: Scalars["String"];
  new_to_date: Scalars["String"];
  only_x_left_in_stock: Float;
  options_container: Scalars["String"];
  price_range: PriceRange;
  price_tiers: Array<TierPrice>;
  product_links: Array<ProductLinks>;
  productattribute: Scalars["String"];
  related_products: ProductItem[];
  short_description: ComplexTextValue;
  sku: Scalars["String"];
  small_image: ProductImage;
  special_price: Scalars["Float"];
  special_to_date: Scalars["String"];
  stock_status: ProductStockStatus;
  swatch_image: Scalars["String"];
  thumbnail: ProductImage;
  uid: Scalars["ID"];
  upgrades: Scalars["String"];
  upsell_products: ProductItem[];
  url_key: Scalars["String"];
...
export type SortFields = {
  ...
  options: Omit<AggregationOption, "count">;
};
...
export type Breadcrumb = {
  ...
  category_level: Scalars["Int"];
  category_name: Scalars["String"];
  category_uid: Scalars["String"];
  category_url_key: Scalars["String"];
  category_url_path: Scalars["String"];
};

export enum CurrenyEnum {
  AFN = "AFN",
  ALL = "ALL",
  AZN = "AZN",
  DZD = "DZD",
...
export type EnquirySuccess = {
  apisuccess: Scalars["Int"];
  enquiryid: Scalars["Int"];
};
...
export type Attribute = {
  attribute_code: Scalars["String"];
  attribute_options: Array<AttributeOption>;
